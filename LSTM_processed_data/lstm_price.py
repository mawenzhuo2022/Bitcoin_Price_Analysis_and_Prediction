...
class FinancialPredictor:
    ...
    def prepare_data(self, data, features, lookback=1):
        """
        Prepare sequences with NaN handling
        """
    ...
    def evaluate(self, y_true, y_pred):
        # Create dummy arrays with same number of features as original data
    ...
    def plot_results(self, y_true, y_pred, dates, title, lookback):
        ...
        if len(y_true_orig) == 0:
            print("Warning: No valid data to plot after removing NaN values")
            return
...
if __name__ == "__main__":
    ...
    # Get target and ALL related features for the period
